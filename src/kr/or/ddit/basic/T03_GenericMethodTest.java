...
class Util {
	 ...
	 * 
	 * 선언방법 : 리턴타입 앞에 <T> 기호를 추가하고 타입 파라미터를 기술 후 사용함.
	 */

	public static <K, V> boolean compare(Pair<K, V> p1, Pair<K, V> p2) {	// <K ,V>로 미리 알려주는 용으로 사용하는듯.
...
public class T03_GenericMethodTest {
	public static void main(String[] args) {
		...
		boolean result1 = Util.<Integer, String>compare(p1, p2); // 구체적 타입을 지정가능, // compare앞에 꺽쇄가 있기때문에 제네릭 타입인걸 알려줌
